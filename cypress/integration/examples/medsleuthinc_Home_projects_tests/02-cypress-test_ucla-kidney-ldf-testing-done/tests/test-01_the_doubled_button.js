import doubledBtnUCLAldf from "../page-object/01_the_doubled_button";
...
describe("transplant kidney donor page test", () => {
  ...
  it("Should check the supplemental.ldf dialog's [the doubled button] issue's fix", () => {
    ...
    // link to the ticket [https://trello.com/c/0JyxE7xw]
    ...
    */
    ...
    cy.visit("/supplemental.ldf")    //1. navigate to the "supplemental.ldf" dialog
      ...
      .get(doubledBtnUCLAldf.introStartSurBtn)
      .should("be.visible")
      .and("have.text", "Start Survey")
      .click();    //3. click to start survey

    cy.get(doubledBtnUCLAldf.submitBtn)   //4. check the visibility of the button
      .should("be.visible")
