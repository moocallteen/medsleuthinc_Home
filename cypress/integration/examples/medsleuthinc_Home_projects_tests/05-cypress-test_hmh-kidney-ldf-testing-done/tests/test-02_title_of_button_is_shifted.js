import btnShiftedTopHMHldf from "../page-objects/02_title_of_button_is_shifted";

describe("transplant kidney donor page test", () => {
  before(() => {
    Cypress.config(
      "baseUrl",
      "https://mobile-survey.mymedsleuth.com/hmh-transplant-kidney-followup/donor-followup-0/dialogs/"
    );
  ...
  it("Should check the supplemental.ldf dialog's [the title of the button is shifted to the top] issue's fix", () => {
    ...
    // link to the ticket [https://trello.com/c/y2JwVyN0]
    ...
    */
    ...
    cy.visit("/supplemental.ldf")    //1. navigate to the "supplemental.ldf" dialog
      ...
      .get(btnShiftedTopHMHldf.introStartSurBtn)
      .should("be.visible")
      .and("have.text", "Start Survey")
      .click();    //3. click to start survey

    cy.get(btnShiftedTopHMHldf.submitBtn)   //4. check the paddings of the button's title
