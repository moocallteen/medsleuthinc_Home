module.exports ={
    ...
    yesRadioBtn : 'input[id="screening.htn.0.item.yes"]',
    noRadioBtn : 'input[id="screening.htn.0.item.no"]',
    nextBtn : 'button[aria-describedby="dialog_prolog entry_prolog"]',
    medicationQtySelect : 'select[name="donor_screen_rx_bp_3_query_entry_0"]', // 'select[id="selectID"]', //'span[class="grommetux-form-field__contents"]', 
    //values: 1, 2, >2
